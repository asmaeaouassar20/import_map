...
<div class="container">
    ...
    <div class="card card-custom">
        <div class="card-body p-4">          
            ...
            <div class="detail-list">
                ...
                <div class="detail-row">
                    <span class="detail-key">
                        <i class="bi bi-graph-up"></i> Taux de réussite
                    </span>
                    <span class="detail-val">
                        <?php 
                        $taux = $r['total'] > 0 ? round(($r['success'] / $r['total']) * 100, 2) : 0;
                        ?>
            ...
            <h4 class="h6 fw-bold mb-3">
                <i class="bi bi-diagram-3"></i> Mapping utilisé
            </h4>
            <div class="mapping-summary">
                <?php foreach ($r['mapping'] as $idx => $dbCol): ?>
                <div class="map-chip">
                    <span class="map-excel">
                        <i class="bi bi-file-excel"></i> <?= htmlspecialchars($r['headers'][$idx] ?? "Colonne " . ($idx + 1)) ?>
                    </span>
    ...
    <div class="result-actions">
        ...
        <?php if ($isSuccess && $r['table']): ?>
        <a href="view_table.php?table=<?= urlencode($r['table']) ?>" class="btn btn-outline-secondary btn-lg">
            <i class="bi bi-eye"></i> Voir la table
        </a>
        <?php endif; ?>
    </div>
